...
jQuery(document).ready(function($){
	...
	function pickColor(id) {
		...
		var Othis = '#' + id;
		var rgb = $(Othis).children('div').css("background-color");
		color = rgb2hex(rgb);
	...
	$('.colorSelector').each(function(){
		...
		$(this).next('input').ColorPicker({}).bind('keyup', function(){
			$(this).prev().children('div').css('backgroundColor', $(this).val());
	...
	$(".slide_add_button").live('click', function(){		
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Slide ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input type="text" class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><div class="slider_bg"><label>Background Image</label><input type="text" class="slide of-input" name="' + sliderId + '[' + newNum + '][bg]" id="' + sliderId + '_' + newNum + '_slide_bg" value="" /><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '_bg" rel="'+sliderInt+'">Upload</span><span class="button mlu_remove_button hide" id="reset_' + sliderId + '_' + newNum + '_bg" title="' + sliderId + '_' + newNum + '_bg">Remove</span></div><div class="screenshot"></div></div><div class="slider_img"><label>Slider Image</label><input type="text" class="slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value="" /><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '_img" rel="'+sliderInt+'">Upload</span><span class="button mlu_remove_button hide" id="reset_' + sliderId + '_' + newNum + '_img" title="' + sliderId + '_' + newNum + '_img">Remove</span></div><div class="screenshot"></div></div><label>Text Mode</label><div class="select_wrapper mini"><span>Dark</span><select class="select of-input" name="' + sliderId + '[' + newNum + '][mode]" id="' + sliderId + '_' + newNum + '_slide_mode"><option id="dark" value="dark" selected="selected">Dark</option><option id="light" value="light">Light</option></select></div><label>Description (optional)</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_description" cols="8" rows="8"></textarea><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
